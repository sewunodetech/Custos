        ...
        <div className="w-full lg:w-1/2 px-6 lg:px-16 lg:pr-[10%]">
          ...
          <div className="max-w-lg relative lg:ml-auto">
            ...
            <div className="relative">
              ...
              <div className="hidden lg:block absolute -right-3 top-0 bottom-0 w-1 opacity-40"

                style={{

                  backgroundImage: 'repeating-linear-gradient(0deg, transparent 0px, transparent 1px, white 1px, white 2px), repeating-linear-gradient(90deg, transparent 0px, transparent 1px, white 1px, white 2px)',
          ...
          <div className="flex items-center gap-3 lg:gap-6 text-[8px] lg:text-[9px] font-mono text-white/50">
            ...
            <div className="hidden lg:flex gap-1">
              ...
              {Array.from({ length: 8 }).map((_, i) => (
                ...
                <div key={i} className="w-1 bg-white/30" style={{ height: `${(i * 3 + 4)}px` }}></div>
